...
{
    public class PostRepository<TEntity> : IPostRepository<TEntity> where TEntity : class, new()
    {
        /// <summary>
        /// Contexto
        /// </summary>
        ...
        public PostRepository(JujuTestContext context)
        {
            _context = context;
        ...
        /// <returns></returns>
        public virtual IEnumerable<Post> GetPostForUser(int Id)
        {
            return _context.Post.Where(e => e.CustomerId == Id).ToList();
        }
